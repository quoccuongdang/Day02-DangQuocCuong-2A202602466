...
| Dữ liệu công khai (Queue-Times API / review Google Maps) | [NHÓM ĐIỀN] | [NHÓM ĐIỀN — ví dụ: phân bố thời gian chờ giờ cao điểm của các trò chơi hot] | | Đây là nguồn duy nhất cho được **số thật** mà không cần quyền truy cập VinWonders |

**Insight sau validation (1-2 câu — pain thật nằm ở đâu):**

```text
[NHÓM ĐIỀN sau khi hỏi thật.]

Giả thuyết nhóm đang đi kiểm: pain thật không phải "phải chờ lâu" — ở công viên đông
thì chờ là chuyện đương nhiên — mà là "phải chờ mà không biết trước sẽ chờ bao lâu",
nên khách không thể quyết định nên đi trò nào trước, trò nào sau.
Nếu giả thuyết này đúng thì bài toán là bài toán THÔNG TIN, và một phần lớn giải
được bằng rule (hiển thị thời gian chờ) chứ chưa cần dự báo bằng AI.
```
...
- [ ] Có validation (quote thật) + research (link kiểm được) — *research đã có 4 link kiểm được; validation (4.1) còn thiếu interview/survey thật*
